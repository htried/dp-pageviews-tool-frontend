<template>
  <div>
    <p class="cdx-docs-demo-text">Selected project value: {{ selection }}</p>

    <cdx-lookup
      v-model:selected="selection"
      :menu-items="menuItems"
      :menu-config="menuConfig"
      aria-label="Lookup wikis"
      @input="onInput"
      @update:selected="$emit( 'project-selected', $event )"
    />
  </div>
</template>
